...
{     
     ...
     /*@
      ...
      /*@
        @ ensures
        @ (((Up_Separation < Positive_RA_Alt_Thresh) && (Down_Separation < Positive_RA_Alt_Thresh) && (Down_Separation < Up_Separation)) ==> (alt_sep != DOWNWARD_RA));  
        @*/
       /*The property P2b*/
       /*@
        @ ensures
        @ (((Up_Separation < Positive_RA_Alt_Thresh) && (Down_Separation < Positive_RA_Alt_Thresh) && (Down_Separation > Up_Separation)) ==> (alt_sep != UPWARD_RA));  
        @*/
        /*The property P3a*/
        /*@
        @ ensures
        @ (((Up_Separation >= Positive_RA_Alt_Thresh) && (Down_Separation >= Positive_RA_Alt_Thresh) && (Own_Tracked_Alt > Other_Tracked_Alt)) ==> (alt_sep != DOWNWARD_RA));  
        @*/  
        /*The property P3b*/
        /*@
        @ ensures
        @ (((Up_Separation >= Positive_RA_Alt_Thresh) && (Down_Separation >= Positive_RA_Alt_Thresh) && (Own_Tracked_Alt < Other_Tracked_Alt)) ==> (alt_sep != UPWARD_RA));  
        @*/
        /*The property P4a*/
        /*@
        @ ensures
        @ ((Own_Tracked_Alt > Other_Tracked_Alt) ==> (alt_sep != DOWNWARD_RA)); 
        @*/

        /*The property P4b*/
        /*@
        @ ensures
        @ ((Own_Tracked_Alt < Other_Tracked_Alt) ==> (alt_sep != UPWARD_RA)); 
        @*/
        /*The property P5a*/
        /*@
        @ ensures
        @ ((Up_Separation > Down_Separation) ==> (alt_sep != DOWNWARD_RA)); 
        @*/

        /*The property P5b*/
        /*@
        @ ensures
        @ ((Up_Separation < Down_Separation) ==> (alt_sep != UPWARD_RA)); 
        @*/
	...
	alt_sep = UNRESOLVED;
		...
		if (upward_preferred)
		    {  
			resultat = (!(Own_Tracked_Alt < Other_Tracked_Alt) || ((Own_Tracked_Alt < Other_Tracked_Alt) && !(Down_Separation >= Positive_RA_Alt_Thresh)));
		    }
		else
		    {  
