...
bool Non_Crossing_Biased_Climb()
{
	...
	result = result && (Own_Tracked_Alt <= Other_Tracked_Alt); /* Add code, this code should be removed */ 
    }
    else
    {	
...
int alt_sep_test()
{
    ...
    {
	need_upward_RA = Non_Crossing_Biased_Climb(); /* Add code, the instruction should be : need_upward_RA = Non_Crossing_Biased_Climb() && Own_Below_Threat(); */
