...
public class InfExpression extends  Comparator {

    public InfExpression(Expression a1, Expression a2) {
    	super(a1, a2);
    }
    ...
    public boolean equals(Object o){
    	return (o instanceof InfExpression) 
    		&& arg1.equals(((InfExpression)o).arg1) 
    		&& arg2.equals(((InfExpression)o).arg2);
    }
    	
    @Override
    public InfExpression substitute(Variable var, Expression val) {
		Expression a1 = arg1.substitute(var, val);
		Expression a2 = arg2.substitute(var, val);
		return new InfExpression(a1, a2);
	}
	
    @Override
    public InfExpression computeLastRenaming(SymbolTable var) {
