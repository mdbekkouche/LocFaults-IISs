...
class Adjacency {
 ...
 public:
  ...
  /** Return the number of occurrences of a variable \a var in a constraint \a ctr. 
   *  \retval n - a value that satisfies 0 <= \a n <= #nb_var() (0 if \a var doest not appear in \a ctr).
   *  \pre 0 <= \a ctr < #nb_ctr(). <br> 0 <= \a var < #nb_var(). */
  inline int ctr_nb_occ_var(int ctr, int var) const { return adj_matrix[IBEX_VAR][ctr][var]; }
  ...
  /** Return the number of occurrences of a univ parameter \a upr in a constraint \a ctr. 
   *  \retval n - a value that satisfies 0 <= \a n <= #nb_upr() (0 if \a upr doest not appear in \a ctr).
   *  \pre 0 <= \a ctr < #nb_ctr(). <br> 0 <= \a upr < #nb_upr(). */
  inline int ctr_nb_occ_upr(int ctr, int upr) const { return adj_matrix[IBEX_UPR][ctr][upr]; }
  ...
  /** Return the number of occurrences of an exist parameter \a epr in a constraint \a ctr. 
   *  \retval n - a value that satisfies 0 <= \a n <= #nb_epr() (0 if \a epr doest not appear in \a ctr).
   *  \pre 0 <= \a ctr < #nb_ctr(). <br> 0 <= \a epr < #nb_epr(). */
  inline int ctr_nb_occ_epr(int ctr, int epr) const { return adj_matrix[IBEX_EPR][ctr][epr]; }
  ...
  /** Return the number of occurrences of a symbolic constant \a syb in a constraint \a ctr. 
   *  \retval n - a value that satisfies 0 <= \a n <= #nb_syb() (0 if \a syb doest not appear in \a ctr).
   *  \pre 0 <= \a ctr < #nb_ctr(). <br> 0 <= \a syb < #nb_syb(). */
  inline int ctr_nb_occ_syb(int ctr, int syb) const { return adj_matrix[IBEX_SYB][ctr][syb]; }
